...
%prep
%setup -q -n libwebp-1.2.2
cd %{_builddir}/libwebp-1.2.2
pushd ..
cp -a libwebp-1.2.2 build32
popd
pushd ..
cp -a libwebp-1.2.2 buildavx2
popd
...
/usr/lib32/libwebp.so.7.1.3
/usr/lib32/libwebpdemux.so.2
/usr/lib32/libwebpdemux.so.2.0.9
/usr/lib32/libwebpmux.so.3
/usr/lib32/libwebpmux.so.3.0.8
