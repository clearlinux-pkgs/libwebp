...
Version  : 1.2.3
Release  : 44
URL      : https://github.com/webmproject/libwebp/archive/v1.2.3/libwebp-1.2.3.tar.gz
Source0  : https://github.com/webmproject/libwebp/archive/v1.2.3/libwebp-1.2.3.tar.gz
...
%prep
%setup -q -n libwebp-1.2.3
cd %{_builddir}/libwebp-1.2.3
pushd ..
cp -a libwebp-1.2.3 build32
popd
pushd ..
cp -a libwebp-1.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658093430
...
cp %{_builddir}/libwebp-1.2.3/COPYING %{buildroot}/usr/share/package-licenses/libwebp/59cd938fcbd6735b1ef91781280d6eb6c4b7c5d9
pushd ../build32/
%make_install32
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebp.so.7.1.4
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpdemux.so.2
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpdemux.so.2.0.10
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpmux.so.3
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpmux.so.3.0.9
/usr/lib64/libwebp.so.7
/usr/lib64/libwebp.so.7.1.4
/usr/lib64/libwebpdemux.so.2
/usr/lib64/libwebpdemux.so.2.0.10
/usr/lib64/libwebpmux.so.3
/usr/lib64/libwebpmux.so.3.0.9

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libwebp.so.7
/usr/lib32/libwebp.so.7.1.4
/usr/lib32/libwebpdemux.so.2
/usr/lib32/libwebpdemux.so.2.0.10
/usr/lib32/libwebpmux.so.3
/usr/lib32/libwebpmux.so.3.0.9
