...
Source0  : https://github.com/webmproject/libwebp/archive/v1.4.0/libwebp-1.4.0.tar.gz
...
%prep
%setup -q -n libwebp-1.4.0
cd %{_builddir}/libwebp-1.4.0
pushd ..
cp -a libwebp-1.4.0 build32
popd
pushd ..
cp -a libwebp-1.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713036253
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libsharpyuv.so.0.1.0
/V3/usr/lib64/libwebp.so.7.1.9
/V3/usr/lib64/libwebpdemux.so.2.0.15
/V3/usr/lib64/libwebpmux.so.3.1.0
...
/usr/lib64/libwebpdemux.so.2.0.15
/usr/lib64/libwebpmux.so.3
/usr/lib64/libwebpmux.so.3.1.0
