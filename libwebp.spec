...
%prep
%setup -q -n libwebp-1.2.4
cd %{_builddir}/libwebp-1.2.4
pushd ..
cp -a libwebp-1.2.4 build32
popd
pushd ..
cp -a libwebp-1.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659969003
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebp.so.7.1.5
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpdemux.so.2
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpdemux.so.2.0.11
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpmux.so.3
/usr/lib64/glibc-hwcaps/x86-64-v3/libwebpmux.so.3.0.10
/usr/lib64/libwebp.so.7
/usr/lib64/libwebp.so.7.1.5
/usr/lib64/libwebpdemux.so.2
/usr/lib64/libwebpdemux.so.2.0.11
/usr/lib64/libwebpmux.so.3
/usr/lib64/libwebpmux.so.3.0.10

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libwebp.so.7
/usr/lib32/libwebp.so.7.1.5
/usr/lib32/libwebpdemux.so.2
/usr/lib32/libwebpdemux.so.2.0.11
/usr/lib32/libwebpmux.so.3
/usr/lib32/libwebpmux.so.3.0.10
